...
const VideoChat: NextPageWithLayout = () => {
  ...
  const [ablyRealtime, setAblyRealtime] = useState(new Realtime({ key: '6fGUDg.SThcrA:OIucr31seGQQ61p5Ub2yX_eao3qnR80oNcZNrQSL2Rw', clientId: session?.data?.user?.id, echoMessages: false }));
